        ...
        <div className="bg-white border border-slate-200 rounded p-4 sm:p-6 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded text-[10px] sm:text-[11px] font-bold bg-rose-50 text-rose-800 border border-rose-200 uppercase">
                Directorate Level Control
              </span>
              <span className="text-[11px] sm:text-xs text-slate-500 font-mono">Status: Live Feed</span>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 text-xs font-bold uppercase tracking-wider text-slate-900 bg-amber-400 hover:bg-amber-300 rounded shadow-xs transition-colors inline-flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
