...
const Login = () => {
  const [tab, setTab] = useState('teacher'); // 'teacher' | 'trainee' | 'admin'
  ...
  const handleTeacherLogin = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.message || 'Institute login failed');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleTraineeLogin = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.message || 'Trainee login failed');
    } finally {
      setLoading(false);
    }
  };
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="e.g. INST-YEAR-XXXX"
